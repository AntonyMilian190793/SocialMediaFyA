package com.antonymilian.socialmediafya.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.antonymilian.socialmediafya";
    private static final String CHANNEL_NAME = "SocialMediaFyA";
    ...
    public NotificationCompat.Builder getNotificationMessage(
        ...
        if(bitmapReceiver == null){
            person1 = new Person.Builder()
                    ...
                    .setIcon(IconCompat.createWithResource(getApplicationContext(), R.drawable.ic_person2))
                    .build();
        }else{
             person1 = new Person.Builder()
                    .setName(usernameReceiver)
